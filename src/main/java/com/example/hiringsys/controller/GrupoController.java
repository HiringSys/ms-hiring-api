...
public class GrupoController {
    ...
    private GrupoResponse grupoResponse(Grupo g){return new GrupoResponse(g.getId(),g.getNome(),g.getArea(),g.getEstado(),g.getDisponiveis(),g.getCargo(),g.getLimiteAprovados(),g.getEmailEquipe(),g.getCriadoEm());}
