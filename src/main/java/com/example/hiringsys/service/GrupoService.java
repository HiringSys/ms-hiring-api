...
public class GrupoService {
    ...
    @Transactional public Grupo salvar(Grupo grupo){grupo.setId(null);validar(grupo,null);return repository.save(grupo);}
    @Transactional public Grupo atualizar(Long id,Grupo dados){Grupo grupo=buscarPorId(id);validar(dados,id);grupo.setNome(dados.getNome());grupo.setArea(dados.getArea());grupo.setEstado(dados.getEstado());grupo.setDisponiveis(dados.getDisponiveis());grupo.setCargo(dados.getCargo());return repository.save(grupo);}
